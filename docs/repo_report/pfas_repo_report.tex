...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{module_architecture.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{git_history.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth]{workflow_overview.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth]{run_directory_layout.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth]{descriptor_pipeline.pdf}
